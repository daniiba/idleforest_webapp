...
import { ArrowRight, Leaf, Chrome, Wifi, TreePine, PlayCircle, CheckCircle2, Shield, BadgeCheck, BarChart3, ShieldCheck, Globe, Users, DollarSign, Monitor, Smartphone, Share2, Award, Check, Download, ChevronDown, Apple, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function LandingPageScreenshots({ deviceInfo }: { deviceInfo?: DeviceDetection }) {
    ...
    useEffect(() => {
        const timer = setInterval(nextScreenshot, 2000); // Changed to 5000ms for better viewing experience? No, let's stick to user request/default but make it auto.
    ...
    useEffect(() => {
        ...
        if (typeof window !== "undefined" && window.clarity) {
            window.clarity("set", "ab_variant", "screenshots");
        }
            ...
            <main className="min-h-screen bg-brand-gray text-white">
                ...
                <section className="relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 py-24">
                        <div className="grid grid-cols-1 lg:grid-cols-[0.7fr_1.3fr] gap-6 sm:gap-10 lg:gap-12 items-center">
                            ...
                            <div className="relative w-full flex items-center justify-center">
                                <div className="w-full max-w-lg lg:max-w-full aspect-video rounded-xl overflow-hidden relative group">
                                    <div className="relative w-full h-full">
                                        <Image
                                            src={screenshots[currentScreenshot]}
                                            alt={`Screenshot ${currentScreenshot + 1}`}
                                            fill
                                            className="object-contain" // kept contain to fit nicely
                                        />
                                    </div>
