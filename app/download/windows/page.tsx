...
import { ArrowRight, BadgeCheck, Chrome, Download, Monitor, ShieldCheck, Sprout, TreePine, Wifi } from "lucide-react";
...
const faqs = [
  {
    question: "Is the Windows app free?",
    answer:
  ...
  {
    question: "Which versions of Windows does it support?",
    answer:
      "IdleForest runs on Windows 10 and Windows 11. The app is light and runs in the background without slowing your machine.",
  },
  {
  ...
  {
    question: "How do I uninstall it on Windows?",
    answer:
      "Open Settings, go to Apps, find IdleForest, and click uninstall. Once removed, no bandwidth is used. The trees you have already funded stay funded.",
  },
];
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-brand-gray text-black">
            ...
            <div className="grid gap-10 lg:grid-cols-[1fr_380px] lg:items-center">
              <div className="max-w-4xl">
                ...
                <h1 className="font-rethink-sans text-[42px] font-extrabold leading-[1.02] tracking-normal sm:text-6xl md:text-7xl">
                  The Free Tree Planting App for Windows
                </h1>
                <p className="mt-6 max-w-3xl text-lg leading-8 text-neutral-800 md:text-xl">
                  IdleForest is a free Windows app that plants verified trees while you use your computer. It runs in
                  the background and uses the internet bandwidth you are not using to fund tree-planting projects. You
              ...
              <div className="rounded-lg border-2 border-black bg-white p-6 shadow-[8px_8px_0px_0px_rgba(11,16,31,1)]">
                <div className="grid gap-4">
                  <Signal icon={<Monitor className="h-5 w-5" />} label="Runs on Windows 10 and 11" />
        ...
        <ContentBand title="What the Windows App Does">
          <p>
          ...
          <p>
            It runs as a lightweight Windows app and starts with your computer, so it keeps funding trees even when your
        ...
        <ContentBand title="Why the Desktop App Plants More Than the Extension" tinted>
          <p>
            The Chrome extension only runs while Chrome is open. The Windows app runs whenever your computer is on, even
          ...
          <div className="container mx-auto px-6 py-16 md:py-24">
            <div className="max-w-4xl">
              <h2 className="font-rethink-sans text-4xl font-extrabold tracking-normal text-brand-yellow md:text-5xl">
                How to Install IdleForest on Windows
              </h2>
            ...
            <div className="mt-12 grid gap-5 md:grid-cols-3">
              <StepCard id="step-1" number="1." title="Download the App">
                Click “Download for Windows” on this page. The .exe installer downloads to your computer.
              </StepCard>
              <StepCard id="step-2" number="2." title="Run the Installer">
                Open the downloaded .exe file and follow the prompts. The install takes about a minute.
              </StepCard>
          ...
          <div className="container mx-auto px-6 py-16 text-center md:py-24">
            <div className="mx-auto max-w-3xl">
              ...
              <h2 className="mt-5 font-rethink-sans text-4xl font-extrabold tracking-normal md:text-6xl">
                Install IdleForest on Windows in a Minute
              </h2>
...
function WindowsCtas({ centered = false }: { centered?: boolean }) {
  return (
    <div className={`mt-8 flex flex-col gap-4 ${centered ? "items-center" : ""}`}>
      <Button asChild className="h-auto rounded-full bg-black px-7 py-4 text-base font-bold text-brand-yellow hover:bg-brand-navy">
        <a href={windowsInstallerHref} className="inline-flex items-center gap-2">
          <Download className="h-5 w-5" />
          Download for Windows — It’s Free
        </a>
      </Button>
      <div className="flex flex-wrap items-center gap-x-3 gap-y-2 text-sm font-bold md:text-base">
        <span>Use Mac instead?</span>
        <Link href="/download/mac" className="underline underline-offset-4 hover:text-brand-navy">
          Get the Mac app
        </Link>
        <span>·</span>
