...
export function GameHeader({ startTime, onOpenLeaderboard, onOpenStats }: GameHeaderProps) {
    return (
        <div className="flex flex-col gap-8">
            <div className="bg-white border-2 border-black p-6 shadow-none flex items-center justify-between">
                <div>
                ...
                <div className="flex gap-4 items-center">
                    <button
                        ...
                        className="bg-brand-yellow border-2 border-black px-4 py-2 font-candu text-lg uppercase tracking-widest hover:bg-yellow-400 hover:-translate-y-0.5 transition-all shadow-none flex items-center gap-2"
                    >
                        <span>🏆</span>
                    ...
                    <button
                        onClick={onOpenStats}
                        className="bg-white border-2 border-black px-4 py-2 font-candu text-lg uppercase tracking-widest hover:bg-neutral-100 hover:-translate-y-0.5 transition-all shadow-none flex items-center gap-2"
                        title="Statistics"
                    >
                        <span>📊</span>
                    </button>
