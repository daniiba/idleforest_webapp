ALTER TABLE public.companies
  ...
  ADD COLUMN IF NOT EXISTS payout_rate_cents_per_1000_points INTEGER NOT NULL DEFAULT 55;

UPDATE public.companies
SET
  impact_mode = COALESCE(impact_mode, 'idleforest_planting'),
  payout_rate_cents_per_1000_points = COALESCE(payout_rate_cents_per_1000_points, 55);

ALTER TABLE public.companies
  ALTER COLUMN impact_mode SET DEFAULT 'idleforest_planting',
  ALTER COLUMN impact_mode SET NOT NULL,
  ALTER COLUMN payout_rate_cents_per_1000_points SET DEFAULT 55,
